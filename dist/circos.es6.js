...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__src_matcher__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_8__src_select__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_10__src_selection_index__["b"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_12__src_selectorAll__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_selection_style__ = __webpack_require__(163);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_13__src_selection_style__["b"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_8__src_symbol__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_9__src_symbol_circle__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_symbol_cross__ = __webpack_require__(173);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_10__src_symbol_cross__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_symbol_diamond__ = __webpack_require__(174);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_11__src_symbol_diamond__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_symbol_square__ = __webpack_require__(176);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_12__src_symbol_square__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_symbol_star__ = __webpack_require__(175);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_13__src_symbol_star__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_symbol_triangle__ = __webpack_require__(177);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return __WEBPACK_IMPORTED_MODULE_14__src_symbol_triangle__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_symbol_wye__ = __webpack_require__(178);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return __WEBPACK_IMPORTED_MODULE_15__src_symbol_wye__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_27__src_curve_linear__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__behaviors_tooltip__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__behaviors_selectaction_js__ = __webpack_require__(463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_dispatch__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_d3_shape__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_selection__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_utils__ = __webpack_require__(464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils__ = __webpack_require__(206);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__colors__ = __webpack_require__(558);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__axes__ = __webpack_require__(600);
...
const uuidv4 = __webpack_require__(235);
/**
...
class Track {
  constructor(instance, conf, defaultConf, data, dataParser) {
    this.dispatch = Object(__WEBPACK_IMPORTED_MODULE_2_d3_dispatch__["a" /* dispatch */])('mouseover', 'mouseout', 'mouseclick');
    this.parseData = dataParser;
    this.loadData(data, instance);
    this.conf = Object(__WEBPACK_IMPORTED_MODULE_5__config_utils__["a" /* getConf */])(conf, defaultConf, this.meta, instance);
    this.conf.colorValue = Object(__WEBPACK_IMPORTED_MODULE_7__colors__["a" /* buildColorValue */])(this.conf.color, this.conf.cmin, this.conf.cmax, this.conf.logScale, this.conf.logScaleBase);
    this.scale = Object(__WEBPACK_IMPORTED_MODULE_6__utils__["a" /* buildScale */])(this.conf.cmin, this.conf.cmax, this.conf.outerRadius - this.conf.innerRadius, this.conf.logScale, this.conf.logScaleBase);
  }
  ...
  render(instance, parentElement, name) {
    ...
    const track = parentElement.append('g').attr('class', name).attr('z-index', this.conf.zIndex);
    this.renderTrackLabel(track, instance._layout, this.conf);

    if (this.conf.axes && this.conf.axes.length > 0) {
      Object(__WEBPACK_IMPORTED_MODULE_8__axes__["b" /* renderAxesLabels */])(track, this.conf, instance._layout, this.scale); //Do this before generating datumContainer, otherwise it will repeat the axes labels for each block rendered
    }

    const datumContainer = this.renderBlock(track, this.data, instance._layout, this.conf);

    if (this.conf.axes && this.conf.axes.length > 0) {
      Object(__WEBPACK_IMPORTED_MODULE_8__axes__["a" /* renderAxes */])(datumContainer, this.conf, instance, this.scale);
    }

    const selection = this.renderDatum(datumContainer, this.conf, instance._layout);

    if (this.conf.tooltipContent) {
      Object(__WEBPACK_IMPORTED_MODULE_0__behaviors_tooltip__["a" /* registerTooltip */])(this, instance, selection, this.conf);
    }

    if (this.conf.selectAction) {
      Object(__WEBPACK_IMPORTED_MODULE_1__behaviors_selectaction_js__["a" /* registerSelectAction */])(this, instance, selection, this.conf);
    }
    ...
    Object.keys(this.conf.events).forEach(eventName => {
      ...
      selection.on(eventName, function (d, i, nodes) {
        conf.events[eventName](d, i, nodes, __WEBPACK_IMPORTED_MODULE_4_d3_selection__["a" /* event */]);
      });
    });
    return this;
  }
  ...
  renderBlock(parentElement, data, layout, conf) {
    ...
    if (conf.backgrounds) {
      ...
      }).enter().append('path').attr('class', 'background').attr('fill', background => background.color).attr('opacity', background => background.opacity || 1).attr('d', Object(__WEBPACK_IMPORTED_MODULE_3_d3_shape__["a" /* arc */])().innerRadius(background => {
  ...
  renderTrackLabel(parentElement, layout, conf) {
    ...
    if (layout.conf.trackLabelBlockId !== undefined && layout.conf.trackLabelBlockId in layout.blocks) {
      if ("trackLabelConf" in conf && "label" in conf.trackLabelConf && conf.trackLabelConf.label !== undefined) {
        const labelBlock = parentElement.append('g').attr('class', 'label-block').attr('transform', `rotate(${layout.blocks[layout.conf.trackLabelBlockId].start * 360 / (2 * Math.PI)})`);
        const radius = (conf.innerRadius + conf.outerRadius) / 2;
        const arcid = 'arcid-' + uuidv4();
        labelBlock.append('path').attr('class', 'label-arcpath').attr('fill', 'none').attr('stroke', 'none').attr('opacity', 1).attr('d', Object(__WEBPACK_IMPORTED_MODULE_3_d3_shape__["a" /* arc */])().innerRadius(radius).outerRadius(radius).startAngle(0).endAngle(layout.blocks[layout.conf.trackLabelBlockId].end - layout.blocks[layout.conf.trackLabelBlockId].start)).attr('id', arcid);
        const label = labelBlock.append('text').attr('class', conf.trackLabelConf.class).attr('text-anchor', 'start'); // http://stackoverflow.com/questions/20447106/how-to-center-horizontal-and-vertical-text-along-an-textpath-inside-an-arc-usi

        const labelPath = label.append('textPath').attr('startOffset', '0%').attr('xlink:href', '#' + arcid).text(conf.trackLabelConf.label);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["e"] = parseSpanValueData;
/* harmony export (immutable) */ __webpack_exports__["d"] = parseSpanStringData;
/* harmony export (immutable) */ __webpack_exports__["c"] = parsePositionValueData;
/* harmony export (immutable) */ __webpack_exports__["b"] = parsePositionTextData;
/* harmony export (immutable) */ __webpack_exports__["a"] = parseChordData;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_keys__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_includes__ = __webpack_require__(607);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_every__ = __webpack_require__(611);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_map__ = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_collection__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_d3_array__ = __webpack_require__(8);
...
function checkParent(key, index, layoutSummary, header) {
  if (!__WEBPACK_IMPORTED_MODULE_1_lodash_includes___default()(__WEBPACK_IMPORTED_MODULE_0_lodash_keys___default()(layoutSummary), key)) {
...
function checkNumber(keys, index) {
  return __WEBPACK_IMPORTED_MODULE_2_lodash_every___default()(keys, (value, header) => {
    if (isNaN(value)) {
...
function normalize(data, idKeys) {
  const sampleKeys = __WEBPACK_IMPORTED_MODULE_0_lodash_keys___default()(data[0]);
  const isObject = __WEBPACK_IMPORTED_MODULE_2_lodash_every___default()(__WEBPACK_IMPORTED_MODULE_3_lodash_map___default()(idKeys, key => __WEBPACK_IMPORTED_MODULE_1_lodash_includes___default()(sampleKeys, key)));

  if (isObject) {
    return __WEBPACK_IMPORTED_MODULE_3_lodash_map___default()(data, datum => {
      return __WEBPACK_IMPORTED_MODULE_3_lodash_map___default()(idKeys, key => datum[key]);
    });
  }
...
function buildOutput(data) {
  return {
    data: Object(__WEBPACK_IMPORTED_MODULE_4_d3_collection__["b" /* nest */])().key(datum => datum.block_id).entries(data),
    meta: {
      min: Object(__WEBPACK_IMPORTED_MODULE_5_d3_array__["e" /* min */])(data, d => d.value),
      max: Object(__WEBPACK_IMPORTED_MODULE_5_d3_array__["d" /* max */])(data, d => d.value)
    }
  };
}
...
function parseSpanStringData(data, layoutSummary) {
  ...
  const filteredData = data.filter((datum, index) => checkParent(datum.block_id, index, layoutSummary, 'parent')).filter((datum, index) => checkNumber({
    start: datum.start,
    end: datum.end
  }, index)).filter(datum => {
...
function parseChordData(data, layoutSummary) {
  ...
  return {
    data: formatedData,
    meta: {
      min: Object(__WEBPACK_IMPORTED_MODULE_5_d3_array__["e" /* min */])(formatedData, d => d.value),
      max: Object(__WEBPACK_IMPORTED_MODULE_5_d3_array__["d" /* max */])(formatedData, d => d.value)
    }
  };
}
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return axes; });
/* unused harmony export palette */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return radial; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return values; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return common; });
const axes = {
  axes: {
    value: [],
    iteratee: false
...
var baseConvert = __webpack_require__(466),
    util = __webpack_require__(468);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tickFormat__ = __webpack_require__(519);
...
var baseSetData = __webpack_require__(207),
    createBind = __webpack_require__(470),
    createCurry = __webpack_require__(471),
    createHybrid = __webpack_require__(209),
    createPartial = __webpack_require__(485),
    getData = __webpack_require__(116),
    mergeData = __webpack_require__(486),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_millisecond__ = __webpack_require__(534);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_second__ = __webpack_require__(535);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_hour__ = __webpack_require__(537);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_week__ = __webpack_require__(539);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_month__ = __webpack_require__(540);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_year__ = __webpack_require__(541);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_utcMinute__ = __webpack_require__(542);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_utcHour__ = __webpack_require__(543);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_utcMonth__ = __webpack_require__(546);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_utcYear__ = __webpack_require__(547);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = registerTooltip;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_selection__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_transition__ = __webpack_require__(411);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tooltip_css__ = __webpack_require__(458);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tooltip_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__tooltip_css__);



function registerTooltip(track, instance, element, trackParams) {
  track.dispatch.on('mouseover', d => {
    instance.tip.html(trackParams.tooltipContent(d)).transition().style('opacity', 0.9).style('left', __WEBPACK_IMPORTED_MODULE_0_d3_selection__["a" /* event */].pageX + 'px').style('top', __WEBPACK_IMPORTED_MODULE_0_d3_selection__["a" /* event */].pageY - 28 + 'px');
  });
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = smartBorders;
/* unused harmony export computeMinMax */
/* harmony export (immutable) */ __webpack_exports__["a"] = buildScale;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp_sortBy__ = __webpack_require__(465);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp_sortBy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_fp_sortBy__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_fp_flow__ = __webpack_require__(498);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_fp_concat__ = __webpack_require__(501);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_fp_concat___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash_fp_concat__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_fp_filter__ = __webpack_require__(503);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_fp_first__ = __webpack_require__(506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_fp_first___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash_fp_first__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash_fp_reverse__ = __webpack_require__(510);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash_fp_reverse___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_lodash_fp_reverse__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_d3_scale__ = __webpack_require__(221);
...
function smartBorders(conf, layout, tracks) {
  ...
  const externalTrack = __WEBPACK_IMPORTED_MODULE_1_lodash_fp_flow___default()(__WEBPACK_IMPORTED_MODULE_3_lodash_fp_filter___default()('conf.outerRadius'), __WEBPACK_IMPORTED_MODULE_0_lodash_fp_sortBy___default()('conf.outerRadius'), __WEBPACK_IMPORTED_MODULE_5_lodash_fp_reverse___default.a, __WEBPACK_IMPORTED_MODULE_4_lodash_fp_first___default.a)(__WEBPACK_IMPORTED_MODULE_2_lodash_fp_concat___default()(tracks, layout));
  return {
...
function buildScale(min, max, height, logScale = false, logScaleBase = Math.E) {
  ...
  const scale = logScale && min * max > 0 ? Object(__WEBPACK_IMPORTED_MODULE_6_d3_scale__["b" /* scaleLog */])().base(logScaleBase) : Object(__WEBPACK_IMPORTED_MODULE_6_d3_scale__["a" /* scaleLinear */])();
...
var composeArgs = __webpack_require__(210),
    ...
    countHolders = __webpack_require__(472),
...
var LazyWrapper = __webpack_require__(114),
    ...
    lodash = __webpack_require__(475);
...
var realNames = __webpack_require__(474);
...
var getWrapDetails = __webpack_require__(477),
    insertWrapDetails = __webpack_require__(478),
    setToString = __webpack_require__(78),
    updateWrapDetails = __webpack_require__(479);
...
var baseFindIndex = __webpack_require__(481),
    baseIsNaN = __webpack_require__(482),
    strictIndexOf = __webpack_require__(483);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_band__ = __webpack_require__(512);
/* unused harmony reexport scaleBand */
/* unused harmony reexport scalePoint */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_identity__ = __webpack_require__(518);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_log__ = __webpack_require__(529);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_pow__ = __webpack_require__(530);
/* unused harmony reexport scalePow */
/* unused harmony reexport scaleSqrt */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_quantile__ = __webpack_require__(531);
/* unused harmony reexport scaleQuantile */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_quantize__ = __webpack_require__(532);
/* unused harmony reexport scaleQuantize */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_threshold__ = __webpack_require__(533);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_utcTime__ = __webpack_require__(549);
/* unused harmony reexport scaleUtc */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_category10__ = __webpack_require__(550);
/* unused harmony reexport schemeCategory10 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_category20b__ = __webpack_require__(551);
/* unused harmony reexport schemeCategory20b */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_category20c__ = __webpack_require__(552);
/* unused harmony reexport schemeCategory20c */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_category20__ = __webpack_require__(553);
/* unused harmony reexport schemeCategory20 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_cubehelix__ = __webpack_require__(554);
/* unused harmony reexport interpolateCubehelixDefault */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_rainbow__ = __webpack_require__(555);
/* unused harmony reexport interpolateRainbow */
/* unused harmony reexport interpolateWarm */
/* unused harmony reexport interpolateCool */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_viridis__ = __webpack_require__(556);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_sequential__ = __webpack_require__(557);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_18__src_sequential__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_nest__ = __webpack_require__(513);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_set__ = __webpack_require__(514);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_keys__ = __webpack_require__(515);
/* unused harmony reexport keys */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_values__ = __webpack_require__(516);
/* unused harmony reexport values */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_entries__ = __webpack_require__(517);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_defaultLocale__ = __webpack_require__(520);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_precisionFixed__ = __webpack_require__(526);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_precisionPrefix__ = __webpack_require__(527);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_precisionRound__ = __webpack_require__(528);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatGroup__ = __webpack_require__(521);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatNumerals__ = __webpack_require__(522);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__identity__ = __webpack_require__(525);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatRounded__ = __webpack_require__(524);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_isoParse__ = __webpack_require__(548);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_forEach__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_selection__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__layout_index__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__render__ = __webpack_require__(362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tracks_Text__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tracks_Highlight__ = __webpack_require__(614);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tracks_Histogram__ = __webpack_require__(615);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tracks_Chords__ = __webpack_require__(616);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__tracks_Heatmap__ = __webpack_require__(622);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__tracks_Line__ = __webpack_require__(623);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__tracks_Scatter__ = __webpack_require__(624);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__tracks_Stack__ = __webpack_require__(625);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__clipboard__ = __webpack_require__(626);
...
class Core {
  constructor(conf) {
    this.tracks = {};
    this._layout = null;
    this.conf = __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep___default()(conf, defaultConf);
    this.action = null;
    const container = Object(__WEBPACK_IMPORTED_MODULE_4_d3_selection__["d" /* select */])(this.conf.container).append('div') // Container class to make it responsive.
    .classed("svg-container", true);
    this.svg = container.append('svg') // Responsive SVG needs these 2 attributes and no width and height attr.
    .attr("preserveAspectRatio", "xMinYMin meet").attr("viewBox", "0 0 " + this.conf.width + " " + this.conf.height) // Class to make it responsive.
    .classed("svg-content-responsive", true);

    if (Object(__WEBPACK_IMPORTED_MODULE_4_d3_selection__["d" /* select */])('body').select('.circos-tooltip').empty()) {
      this.tip = Object(__WEBPACK_IMPORTED_MODULE_4_d3_selection__["d" /* select */])('body').append('div').attr('class', 'circos-tooltip').style('opacity', 0);
    } else {
      this.tip = Object(__WEBPACK_IMPORTED_MODULE_4_d3_selection__["d" /* select */])('body').select('.circos-tooltip');
    }

    this.clipboard = Object(__WEBPACK_IMPORTED_MODULE_15__clipboard__["a" /* initClipboard */])(this.conf.container);
  }
  ...
  detach() {
    ...
    const container = Object(__WEBPACK_IMPORTED_MODULE_4_d3_selection__["d" /* select */])(this.conf.container);
    container.select('div').remove();
    /* Remove container 'div' child */

    const tooltip = Object(__WEBPACK_IMPORTED_MODULE_4_d3_selection__["d" /* select */])('body').select('.circos-tooltip');
  ...
  removeTracks(trackIds) {
    if (typeof trackIds === 'undefined') {
      __WEBPACK_IMPORTED_MODULE_3_lodash_map___default()(this.tracks, (track, id) => {
    ...
    } else if (__WEBPACK_IMPORTED_MODULE_2_lodash_isArray___default()(trackIds)) {
      __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(trackIds, function (trackId) {
  ...
  layout(data, conf) {
    this._layout = new __WEBPACK_IMPORTED_MODULE_5__layout_index__["a" /* default */](conf, data);
    return this;
  }

  chords(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_10__tracks_Chords__["a" /* default */](this, conf, data);
    return this;
  }

  heatmap(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_11__tracks_Heatmap__["a" /* default */](this, conf, data);
    return this;
  }

  highlight(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_8__tracks_Highlight__["a" /* default */](this, conf, data);
    return this;
  }

  histogram(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_9__tracks_Histogram__["a" /* default */](this, conf, data);
    return this;
  }

  line(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_12__tracks_Line__["a" /* default */](this, conf, data);
    return this;
  }

  scatter(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_13__tracks_Scatter__["a" /* default */](this, conf, data);
    return this;
  }

  stack(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_14__tracks_Stack__["a" /* default */](this, conf, data);
    return this;
  }

  text(id, data, conf) {
    this.tracks[id] = new __WEBPACK_IMPORTED_MODULE_7__tracks_Text__["a" /* default */](this, conf, data);
    return this;
  }

  render(ids, removeTracks) {
    Object(__WEBPACK_IMPORTED_MODULE_6__render__["a" /* default */])(ids, removeTracks, this);
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Circos);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_reduce__ = __webpack_require__(100);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_forEach__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__conf__ = __webpack_require__(361);
...
class Layout {
  constructor(conf, data) {
    ...
    this.conf = __WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep___default()(conf, __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep___default()(__WEBPACK_IMPORTED_MODULE_4__conf__["a" /* default */]));
    ...
    const agg = __WEBPACK_IMPORTED_MODULE_2_lodash_reduce___default()(this.data, (aggregator, block) => {
    ...
    this.size = agg.offset; // thanks to sum of blocks' length, compute start and end angles in radian

    __WEBPACK_IMPORTED_MODULE_3_lodash_forEach___default()(this.data, (block, index) => {
  ...
  summary() {
    return __WEBPACK_IMPORTED_MODULE_2_lodash_reduce___default()(this.data, (summary, block) => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_forEach__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_sortBy__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__layout_render__ = __webpack_require__(368);
...
function render(ids = [], removeTracks, circos) {
  ...
  if (removeTracks) {
    __WEBPACK_IMPORTED_MODULE_0_lodash_forEach___default()(circos.tracks, (track, trackId) => {
  ...
  if (renderAll || 'layout' in ids) {
    Object(__WEBPACK_IMPORTED_MODULE_2__layout_render__["a" /* default */])(translated, circos);
  } // re-order tracks and layout according to z-index


  const trackContainers = svg.selectAll('.all > g').remove();
  const sortedTrackContainers = __WEBPACK_IMPORTED_MODULE_1_lodash_sortBy___default()(trackContainers._groups[0], elt => elt.getAttribute('z-index'));
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = renderLayout;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_selection__ = __webpack_require__(3);
...
function renderLayoutLabels(conf, block) {
  ...
  const labelArc = Object(__WEBPACK_IMPORTED_MODULE_0_d3_shape__["a" /* arc */])().innerRadius(radius).outerRadius(radius).startAngle((d, i) => d.start).endAngle((d, i) => d.end);
  block.append('path').attr('fill', 'none').attr('stroke', 'none').attr('d', labelArc).attr('id', d => 'arc-label' + d.id);
  const label = block.append('text').style('font-size', '' + conf.labels.size + 'px').attr('text-anchor', 'middle'); // http://stackoverflow.com/questions/20447106/how-to-center-horizontal-and-vertical-text-along-an-textpath-inside-an-arc-usi

  label.append('textPath').attr('startOffset', '25%').attr('xlink:href', d => '#arc-label' + d.id).style('fill', conf.labels.color).text(d => d.label);
}
...
function renderLayoutTicks(conf, layout, instance) {
  ...
  function blockTicks(d) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_1_d3_array__["g" /* range */])(0, d.len, conf.ticks.spacing).map((v, i) => {
      return {
        angle: v * k + d.start,
  ...
  const ticks = layout.append('g').selectAll('g').data(instance._layout.data).enter().append('g').selectAll('g').data(blockTicks).enter().append('g').attr('transform', d => 'rotate(' + (d.angle * 180 / Math.PI - 90) + ')' + 'translate(' + conf.outerRadius + ',0)');
...
function renderLayout(parentElement, instance) {
  ...
  const layout = parentElement.append('g').attr('class', 'cs-layout').attr('z-index', conf.zIndex).on('click', conf.onClick);
  ...
  Object.keys(conf.events).forEach(eventName => {
    block.on(eventName, function (d, i, nodes) {
      conf.events[eventName](d, i, nodes, __WEBPACK_IMPORTED_MODULE_2_d3_selection__["a" /* event */]);
    });
  });
  const entry = Object(__WEBPACK_IMPORTED_MODULE_0_d3_shape__["a" /* arc */])().innerRadius(conf.innerRadius).outerRadius(conf.outerRadius).cornerRadius(conf.cornerRadius).startAngle(d => d.start).endAngle(d => d.end);
  block.append('path').attr('d', entry).attr('fill', d => d.color).attr('id', d => d.id);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Track__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_parser__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_forEach__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_assign__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__configs__ = __webpack_require__(22);





const defaultConf = __WEBPACK_IMPORTED_MODULE_3_lodash_assign___default()({
  style: {
    value: {},
    iteratee: true
  },
...
}, __WEBPACK_IMPORTED_MODULE_4__configs__["b" /* common */], __WEBPACK_IMPORTED_MODULE_4__configs__["c" /* radial */]);
class Text extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["b" /* parsePositionTextData */]);
  }
  ...
  renderDatum(parentElement, conf, layout) {
    ...
    __WEBPACK_IMPORTED_MODULE_2_lodash_forEach___default()(conf.style, (value, key) => {
...
/* harmony default export */ __webpack_exports__["a"] = (function(name, value) {
  var fullname = Object(__WEBPACK_IMPORTED_MODULE_1_d3_selection__["c" /* namespace */])(name), i = fullname === "transform" ? __WEBPACK_IMPORTED_MODULE_0_d3_interpolate__["i" /* interpolateTransformSvg */] : __WEBPACK_IMPORTED_MODULE_3__interpolate__["a" /* default */];
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = registerSelectAction;
function registerSelectAction(track, instance, element, trackParams) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getConf; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_forEach__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_forEach__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_isFunction__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_assign__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_assign___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash_assign__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils__ = __webpack_require__(206);
...
const buildConf = (userConf = {}, defaultConf) => {
  let conf = {};
  __WEBPACK_IMPORTED_MODULE_1_lodash_forEach___default()(defaultConf, (item, key) => {
    // if it's a leaf
    if (item.iteratee !== undefined) {
      if (!item.iteratee) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2_lodash_isFunction___default()(userConf[key])) {
...
const computeRadius = (conf, instance) => {
  if (conf.innerRadius === 0 && conf.outerRadius === 0) {
    const borders = Object(__WEBPACK_IMPORTED_MODULE_4__utils__["b" /* smartBorders */])(conf, instance._layout, instance.tracks);
    return {
...
const getConf = (userConf, defaultConf, meta, instance) => {
  let conf = buildConf(userConf, __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep___default()(defaultConf));
  __WEBPACK_IMPORTED_MODULE_3_lodash_assign___default()(conf, computeMinMax(conf, meta), computeRadius(conf, instance));
  return conf;
};
...
var mapping = __webpack_require__(467),
...
module.exports = {
  'ary': __webpack_require__(469),
  'assign': __webpack_require__(165),
  'clone': __webpack_require__(490),
  'curry': __webpack_require__(491),
  'forEach': __webpack_require__(64),
  'isArray': __webpack_require__(2),
  'isError': __webpack_require__(492),
  'isFunction': __webpack_require__(24),
  'isWeakMap': __webpack_require__(493),
  'iteratee': __webpack_require__(494),
  'keys': __webpack_require__(143),
  'rearg': __webpack_require__(495),
  'toInteger': __webpack_require__(119),
  'toPath': __webpack_require__(497)
};
...
var LazyWrapper = __webpack_require__(114),
    ...
    isArray = __webpack_require__(2),
    isObjectLike = __webpack_require__(6),
    wrapperClone = __webpack_require__(476);
...
var baseTrim = __webpack_require__(488),
    isObject = __webpack_require__(7),
    isSymbol = __webpack_require__(34);
...
var trimmedEndIndex = __webpack_require__(489);
...
var convert = __webpack_require__(37),
    func = convert('flow', __webpack_require__(499));
...
var createFlow = __webpack_require__(500);
...
var convert = __webpack_require__(37),
    func = convert('concat', __webpack_require__(502));
...
var convert = __webpack_require__(37),
    func = convert('filter', __webpack_require__(504));
...
var arrayFilter = __webpack_require__(149),
    baseFilter = __webpack_require__(505),
    baseIteratee = __webpack_require__(33),
    isArray = __webpack_require__(2);
...
var convert = __webpack_require__(37),
    func = convert('head', __webpack_require__(508), __webpack_require__(509));
...
var convert = __webpack_require__(37),
    func = convert('reverse', __webpack_require__(511));
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = buildColorValue;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isFunction__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_scale__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__ = __webpack_require__(559);



const palettes = {
  BrBG: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["b" /* interpolateBrBG */],
  PRGn: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["j" /* interpolatePRGn */],
  PiYG: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["k" /* interpolatePiYG */],
  PuOr: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["n" /* interpolatePuOr */],
  RdBu: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["q" /* interpolateRdBu */],
  RdGy: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["r" /* interpolateRdGy */],
  RdYlBu: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["t" /* interpolateRdYlBu */],
  RdYlGn: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["u" /* interpolateRdYlGn */],
  Spectral: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["w" /* interpolateSpectral */],
  Blues: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["a" /* interpolateBlues */],
  Greens: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["f" /* interpolateGreens */],
  Greys: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["g" /* interpolateGreys */],
  Oranges: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["i" /* interpolateOranges */],
  Purples: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["p" /* interpolatePurples */],
  Reds: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["v" /* interpolateReds */],
  BuGn: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["c" /* interpolateBuGn */],
  BuPu: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["d" /* interpolateBuPu */],
  GnBu: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["e" /* interpolateGnBu */],
  OrRd: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["h" /* interpolateOrRd */],
  PuBuGn: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["m" /* interpolatePuBuGn */],
  PuBu: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["l" /* interpolatePuBu */],
  PuRd: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["o" /* interpolatePuRd */],
  RdPu: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["s" /* interpolateRdPu */],
  YlGnBu: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["y" /* interpolateYlGnBu */],
  YlGn: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["x" /* interpolateYlGn */],
  YlOrBr: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["z" /* interpolateYlOrBr */],
  YlOrRd: __WEBPACK_IMPORTED_MODULE_2_d3_scale_chromatic__["A" /* interpolateYlOrRd */]
};
function buildColorValue(color, min = null, max = null, logScale = false, logScaleBase = Math.E) {
  if (__WEBPACK_IMPORTED_MODULE_0_lodash_isFunction___default()(color)) {
    return color;
  }
...
const buildColorScale = (interpolator, min, max, reverse = false, logScale = false, logScaleBase = Math.E) => {
  ...
  if (logScale && min * max > 0) {
    const scale = Object(__WEBPACK_IMPORTED_MODULE_1_d3_scale__["b" /* scaleLog */])().base(logScaleBase).domain(reverse ? [max, min] : [min, max]).range([0, 1]);
    return Object(__WEBPACK_IMPORTED_MODULE_1_d3_scale__["c" /* scaleSequential */])(t => {
      return interpolator(scale(t));
    }).domain([0, 1]);
  }

  return Object(__WEBPACK_IMPORTED_MODULE_1_d3_scale__["c" /* scaleSequential */])(interpolator).domain(reverse ? [max, min] : [min, max]);
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_categorical_category10__ = __webpack_require__(560);
/* unused harmony reexport schemeCategory10 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_categorical_Accent__ = __webpack_require__(561);
/* unused harmony reexport schemeAccent */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_categorical_Dark2__ = __webpack_require__(562);
/* unused harmony reexport schemeDark2 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_categorical_Paired__ = __webpack_require__(563);
/* unused harmony reexport schemePaired */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_categorical_Pastel1__ = __webpack_require__(564);
/* unused harmony reexport schemePastel1 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_categorical_Pastel2__ = __webpack_require__(565);
/* unused harmony reexport schemePastel2 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_categorical_Set1__ = __webpack_require__(566);
/* unused harmony reexport schemeSet1 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_categorical_Set2__ = __webpack_require__(567);
/* unused harmony reexport schemeSet2 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_categorical_Set3__ = __webpack_require__(568);
/* unused harmony reexport schemeSet3 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_diverging_BrBG__ = __webpack_require__(569);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_diverging_PRGn__ = __webpack_require__(570);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_10__src_diverging_PRGn__["a"]; });
/* unused harmony reexport schemePRGn */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_diverging_PiYG__ = __webpack_require__(571);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return __WEBPACK_IMPORTED_MODULE_11__src_diverging_PiYG__["a"]; });
/* unused harmony reexport schemePiYG */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_diverging_PuOr__ = __webpack_require__(572);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return __WEBPACK_IMPORTED_MODULE_12__src_diverging_PuOr__["a"]; });
/* unused harmony reexport schemePuOr */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_diverging_RdBu__ = __webpack_require__(573);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return __WEBPACK_IMPORTED_MODULE_13__src_diverging_RdBu__["a"]; });
/* unused harmony reexport schemeRdBu */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_diverging_RdGy__ = __webpack_require__(574);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return __WEBPACK_IMPORTED_MODULE_14__src_diverging_RdGy__["a"]; });
/* unused harmony reexport schemeRdGy */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_diverging_RdYlBu__ = __webpack_require__(575);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return __WEBPACK_IMPORTED_MODULE_15__src_diverging_RdYlBu__["a"]; });
/* unused harmony reexport schemeRdYlBu */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_diverging_RdYlGn__ = __webpack_require__(576);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return __WEBPACK_IMPORTED_MODULE_16__src_diverging_RdYlGn__["a"]; });
/* unused harmony reexport schemeRdYlGn */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_diverging_Spectral__ = __webpack_require__(577);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return __WEBPACK_IMPORTED_MODULE_17__src_diverging_Spectral__["a"]; });
/* unused harmony reexport schemeSpectral */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_sequential_multi_BuGn__ = __webpack_require__(578);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__src_sequential_multi_BuPu__ = __webpack_require__(579);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_sequential_multi_GnBu__ = __webpack_require__(580);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_20__src_sequential_multi_GnBu__["a"]; });
/* unused harmony reexport schemeGnBu */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__src_sequential_multi_OrRd__ = __webpack_require__(581);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_sequential_multi_PuBuGn__ = __webpack_require__(582);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return __WEBPACK_IMPORTED_MODULE_22__src_sequential_multi_PuBuGn__["a"]; });
/* unused harmony reexport schemePuBuGn */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__src_sequential_multi_PuBu__ = __webpack_require__(583);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__src_sequential_multi_PuRd__ = __webpack_require__(584);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return __WEBPACK_IMPORTED_MODULE_24__src_sequential_multi_PuRd__["a"]; });
/* unused harmony reexport schemePuRd */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__src_sequential_multi_RdPu__ = __webpack_require__(585);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return __WEBPACK_IMPORTED_MODULE_25__src_sequential_multi_RdPu__["a"]; });
/* unused harmony reexport schemeRdPu */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__src_sequential_multi_YlGnBu__ = __webpack_require__(586);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return __WEBPACK_IMPORTED_MODULE_26__src_sequential_multi_YlGnBu__["a"]; });
/* unused harmony reexport schemeYlGnBu */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__src_sequential_multi_YlGn__ = __webpack_require__(587);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return __WEBPACK_IMPORTED_MODULE_27__src_sequential_multi_YlGn__["a"]; });
/* unused harmony reexport schemeYlGn */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__src_sequential_multi_YlOrBr__ = __webpack_require__(588);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return __WEBPACK_IMPORTED_MODULE_28__src_sequential_multi_YlOrBr__["a"]; });
/* unused harmony reexport schemeYlOrBr */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__src_sequential_multi_YlOrRd__ = __webpack_require__(589);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return __WEBPACK_IMPORTED_MODULE_29__src_sequential_multi_YlOrRd__["a"]; });
/* unused harmony reexport schemeYlOrRd */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__src_sequential_single_Blues__ = __webpack_require__(590);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__src_sequential_single_Greens__ = __webpack_require__(591);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_31__src_sequential_single_Greens__["a"]; });
/* unused harmony reexport schemeGreens */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__src_sequential_single_Greys__ = __webpack_require__(592);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_32__src_sequential_single_Greys__["a"]; });
/* unused harmony reexport schemeGreys */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__src_sequential_single_Purples__ = __webpack_require__(593);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return __WEBPACK_IMPORTED_MODULE_33__src_sequential_single_Purples__["a"]; });
/* unused harmony reexport schemePurples */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__src_sequential_single_Reds__ = __webpack_require__(594);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return __WEBPACK_IMPORTED_MODULE_34__src_sequential_single_Reds__["a"]; });
/* unused harmony reexport schemeReds */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__src_sequential_single_Oranges__ = __webpack_require__(595);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return __WEBPACK_IMPORTED_MODULE_35__src_sequential_single_Oranges__["a"]; });
/* unused harmony reexport schemeOranges */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__src_sequential_multi_cubehelix__ = __webpack_require__(596);
/* unused harmony reexport interpolateCubehelixDefault */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__src_sequential_multi_rainbow__ = __webpack_require__(597);
/* unused harmony reexport interpolateRainbow */
/* unused harmony reexport interpolateWarm */
/* unused harmony reexport interpolateCool */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__src_sequential_multi_sinebow__ = __webpack_require__(598);
/* unused harmony reexport interpolateSinebow */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__src_sequential_multi_viridis__ = __webpack_require__(599);
/* unused harmony reexport interpolateViridis */
/* unused harmony reexport interpolateMagma */
/* unused harmony reexport interpolateInferno */
/* unused harmony reexport interpolatePlasma */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_range__ = __webpack_require__(601);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_reduce__ = __webpack_require__(100);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__logger__ = __webpack_require__(604);
...
const _buildAxesData = conf => {
  return __WEBPACK_IMPORTED_MODULE_1_lodash_reduce___default()(conf.axes, (aggregator, axesGroup) => {
    if (!axesGroup.position && !axesGroup.spacing) {
      __WEBPACK_IMPORTED_MODULE_3__logger__["a" /* default */].warn('Skipping axe group with no position and spacing defined');
      return aggregator;
    }
    ...
    if (axesGroup.spacing) {
      const builtAxes = __WEBPACK_IMPORTED_MODULE_0_lodash_range___default()(axesGroup.start || conf.cmin, axesGroup.end || conf.cmax, axesGroup.spacing).map(value => {
...
/* unused harmony export _buildAxesData */

const renderAxesLabels = (parentElement, conf, layout, scale) => {
  const axes = _buildAxesData(conf); //Code to handle axis labels


  if (layout.conf.trackLabelBlockId !== undefined && layout.conf.trackLabelBlockId in layout.blocks) {
    const labelBlock = parentElement.append('g').attr('class', 'label-axes-block').attr('transform', `rotate(${layout.blocks[layout.conf.trackLabelBlockId].start * 360 / (2 * Math.PI)})`);
    conf.axes.forEach((a, i) => {
      ...
      if ("axisLabelConf" in a && "label" in a.axisLabelConf && a.axisLabelConf.label !== undefined) {
        const arcid = 'arcid-' + uuidv4();
        const axisBlock = labelBlock.append('g').attr('class', 'label-axis-block');
        axisBlock.append('path').attr('class', 'label-axis-arcpath').attr('fill', 'none').attr('stroke', 'none').attr('opacity', 1).attr('d', Object(__WEBPACK_IMPORTED_MODULE_2_d3_shape__["a" /* arc */])().innerRadius(radius).outerRadius(radius).startAngle(0).endAngle(layout.blocks[layout.conf.trackLabelBlockId].end - layout.blocks[layout.conf.trackLabelBlockId].start)).attr('id', arcid);
        const label = axisBlock.append('text').attr('class', a.axisLabelConf.class).attr('text-anchor', 'end'); // http://stackoverflow.com/questions/20447106/how-to-center-horizontal-and-vertical-text-along-an-textpath-inside-an-arc-usi

        const labelPath = label.append('textPath').attr('startOffset', '50%').attr('xlink:href', '#' + arcid).text(a.axisLabelConf.label);
      }
    });
  }
};
/* harmony export (immutable) */ __webpack_exports__["b"] = renderAxesLabels;

const renderAxes = (parentElement, conf, instance, scale) => {
  const axes = _buildAxesData(conf);

  const layout = instance._layout;
  const axis = Object(__WEBPACK_IMPORTED_MODULE_2_d3_shape__["a" /* arc */])().innerRadius(d => {
  ...
  }).enter().append('path').attr('opacity', d => d.opacity).attr('class', 'axis').attr('d', axis).attr('stroke-width', d => d.thickness).attr('stroke', d => d.color);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = renderAxes;
...
var baseIndexOf = __webpack_require__(217),
    isArrayLike = __webpack_require__(17),
    isString = __webpack_require__(608),
    toInteger = __webpack_require__(119),
...
var arrayEvery = __webpack_require__(612),
    baseEvery = __webpack_require__(613),
    baseIteratee = __webpack_require__(33),
    isArray = __webpack_require__(2),
    isIterateeCall = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Track__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_parser__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_assign__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__configs__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_shape__ = __webpack_require__(13);





const defaultConf = __WEBPACK_IMPORTED_MODULE_2_lodash_assign___default()({
  color: {
    value: '#fd6a62',
    iteratee: true
  },
...
}, __WEBPACK_IMPORTED_MODULE_3__configs__["c" /* radial */], __WEBPACK_IMPORTED_MODULE_3__configs__["b" /* common */]);
class Highlight extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["d" /* parseSpanStringData */]);
  }

  renderDatum(parentElement, conf, layout) {
    return parentElement.selectAll('tile').data(d => d.values).enter().append('path').attr('class', 'tile').attr('d', Object(__WEBPACK_IMPORTED_MODULE_4_d3_shape__["a" /* arc */])().innerRadius(conf.innerRadius).outerRadius(conf.outerRadius).startAngle((d, i) => this.theta(d.start, layout.blocks[d.block_id])).endAngle((d, i) => this.theta(d.end, layout.blocks[d.block_id]))).attr('fill', conf.colorValue).attr('opacity', conf.opacity).attr('stroke-width', conf.strokeWidth).attr('stroke', conf.strokeColor);
  }
...
}, __WEBPACK_IMPORTED_MODULE_4__configs__["a" /* axes */], __WEBPACK_IMPORTED_MODULE_4__configs__["c" /* radial */], __WEBPACK_IMPORTED_MODULE_4__configs__["b" /* common */], __WEBPACK_IMPORTED_MODULE_4__configs__["d" /* values */]);
class Histogram extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["e" /* parseSpanValueData */]);
  }

  renderDatum(parentElement, conf, layout) {
    const bin = parentElement.selectAll('.bin').data(d => d.values).enter().append('path').attr('class', 'bin').attr('opacity', d => conf.opacity).attr('d', Object(__WEBPACK_IMPORTED_MODULE_2_d3_shape__["a" /* arc */])().innerRadius(d => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Track__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_parser__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__behaviors_tooltip__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_d3_chord__ = __webpack_require__(617);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_assign__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash_isFunction__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_d3_selection__ = __webpack_require__(3);
...
const defaultConf = __WEBPACK_IMPORTED_MODULE_4_lodash_assign___default()({
  color: {
    value: '#fd6a62',
    iteratee: true
  },
...
}, __WEBPACK_IMPORTED_MODULE_7__configs__["b" /* common */], __WEBPACK_IMPORTED_MODULE_7__configs__["d" /* values */]);
...
class Chords extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["a" /* parseChordData */]);
  }
  ...
  getCoordinates(d, layout, conf, datum) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_5_lodash_isFunction___default()(conf.radius)) {
  ...
  renderChords(parentElement, name, conf, data, instance, getCoordinates) {
    ...
    const link = track.selectAll('.chord').data(data).enter().append('path').attr('class', 'chord').attr('d', Object(__WEBPACK_IMPORTED_MODULE_3_d3_chord__["a" /* ribbon */])().source(d => getCoordinates(d.source, instance._layout, this.conf, d)).target(d => getCoordinates(d.target, instance._layout, this.conf, d))).attr('opacity', conf.opacity).on('mouseover', d => {
      this.dispatch.call('mouseover', this, d);
    ...
    Object.keys(conf.events).forEach(eventName => {
      link.on(eventName, function (d, i, nodes) {
        conf.events[eventName](d, i, nodes, __WEBPACK_IMPORTED_MODULE_6_d3_selection__["a" /* event */]);
      });
    });
  ...
  render(instance, parentElement, name) {
    ...
    if (this.conf.tooltipContent) {
      Object(__WEBPACK_IMPORTED_MODULE_2__behaviors_tooltip__["a" /* registerTooltip */])(this, instance, selection, this.conf);
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Chords;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_chord__ = __webpack_require__(618);
/* unused harmony reexport chord */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_ribbon__ = __webpack_require__(619);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_1__src_ribbon__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__array__ = __webpack_require__(620);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constant__ = __webpack_require__(621);
...
}, __WEBPACK_IMPORTED_MODULE_4__configs__["c" /* radial */], __WEBPACK_IMPORTED_MODULE_4__configs__["d" /* values */], __WEBPACK_IMPORTED_MODULE_4__configs__["b" /* common */]);
class Heatmap extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["e" /* parseSpanValueData */]);
  }

  renderDatum(parentElement, conf, layout) {
    return parentElement.selectAll('tile').data(d => d.values).enter().append('path').attr('class', 'tile').attr('opacity', conf.opacity).attr('d', Object(__WEBPACK_IMPORTED_MODULE_2_d3_shape__["a" /* arc */])().innerRadius(conf.innerRadius).outerRadius(conf.outerRadius).startAngle((d, i) => this.theta(d.start, layout.blocks[d.block_id])).endAngle((d, i) => this.theta(d.end, layout.blocks[d.block_id]))).attr('fill', conf.colorValue);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_assign__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_assign___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash_assign__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_reduce__ = __webpack_require__(100);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_sortBy__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__configs__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_d3_shape__ = __webpack_require__(13);
...
}, __WEBPACK_IMPORTED_MODULE_5__configs__["a" /* axes */], __WEBPACK_IMPORTED_MODULE_5__configs__["c" /* radial */], __WEBPACK_IMPORTED_MODULE_5__configs__["b" /* common */], __WEBPACK_IMPORTED_MODULE_5__configs__["d" /* values */]);

const splitByGap = (points, maxGap) => {
  return __WEBPACK_IMPORTED_MODULE_3_lodash_reduce___default()(__WEBPACK_IMPORTED_MODULE_4_lodash_sortBy___default()(points, 'position'), (aggregator, datum) => {
...
class Line extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["c" /* parsePositionValueData */]);
  }

  renderDatum(parentElement, conf, layout) {
    const line = Object(__WEBPACK_IMPORTED_MODULE_6_d3_shape__["d" /* radialLine */])().angle(d => d.angle).radius(d => d.radius).curve(__WEBPACK_IMPORTED_MODULE_6_d3_shape__["b" /* curveLinear */]);
    const area = Object(__WEBPACK_IMPORTED_MODULE_6_d3_shape__["c" /* radialArea */])().angle(d => d.angle).innerRadius(d => d.innerRadius).outerRadius(d => d.outerRadius).curve(__WEBPACK_IMPORTED_MODULE_6_d3_shape__["b" /* curveLinear */]);
...
}, __WEBPACK_IMPORTED_MODULE_3__configs__["a" /* axes */], __WEBPACK_IMPORTED_MODULE_3__configs__["c" /* radial */], __WEBPACK_IMPORTED_MODULE_3__configs__["b" /* common */], __WEBPACK_IMPORTED_MODULE_3__configs__["d" /* values */]);

const getSymbol = key => {
  switch (key) {
    case 'circle':
      return __WEBPACK_IMPORTED_MODULE_4_d3_shape__["f" /* symbolCircle */];

    case 'cross':
      return __WEBPACK_IMPORTED_MODULE_4_d3_shape__["g" /* symbolCross */];

    case 'diamond':
      return __WEBPACK_IMPORTED_MODULE_4_d3_shape__["h" /* symbolDiamond */];

    case 'square':
      return __WEBPACK_IMPORTED_MODULE_4_d3_shape__["i" /* symbolSquare */];

    case 'triangle':
      return __WEBPACK_IMPORTED_MODULE_4_d3_shape__["k" /* symbolTriangle */];

    case 'star':
      return __WEBPACK_IMPORTED_MODULE_4_d3_shape__["j" /* symbolStar */];

    case 'wye':
      return __WEBPACK_IMPORTED_MODULE_4_d3_shape__["l" /* symbolWye */];
...
class Scatter extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["c" /* parsePositionValueData */]);
  }
  ...
  renderDatum(parentElement, conf, layout) {
    const point = parentElement.selectAll('.point').data(d => {
      d.values.forEach((item, i) => {
        item.symbol = Object(__WEBPACK_IMPORTED_MODULE_4_d3_shape__["e" /* symbol */])().type(getSymbol(conf.shape)).size(conf.size);
      });
      return d.values;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_assign__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_assign___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash_assign__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_forEach__ = __webpack_require__(32);
...
}, __WEBPACK_IMPORTED_MODULE_5__configs__["a" /* axes */], __WEBPACK_IMPORTED_MODULE_5__configs__["c" /* radial */], __WEBPACK_IMPORTED_MODULE_5__configs__["d" /* values */], __WEBPACK_IMPORTED_MODULE_5__configs__["b" /* common */]);
class Stack extends __WEBPACK_IMPORTED_MODULE_0__Track__["a" /* default */] {
  constructor(instance, conf, data) {
    super(instance, conf, defaultConf, data, __WEBPACK_IMPORTED_MODULE_1__data_parser__["e" /* parseSpanValueData */]);
  ...
  buildLayers(data, margin) {
    __WEBPACK_IMPORTED_MODULE_4_lodash_forEach___default()(data, (block, idx) => {
      ...
      let layers = [];
      __WEBPACK_IMPORTED_MODULE_4_lodash_forEach___default()(block.values, datum => {
        let placed = false;
        __WEBPACK_IMPORTED_MODULE_4_lodash_forEach___default()(layers, (layer, i) => {
          // try to place datum
  ...
  renderDatum(parentElement, conf, layout) {
    ...
    return parentElement.selectAll('.tile').data(d => {
      return d.values.map(datum => {
        ...
        return __WEBPACK_IMPORTED_MODULE_3_lodash_assign___default()(datum, {
    ...
    }).enter().append('path').attr('class', 'tile').attr('d', Object(__WEBPACK_IMPORTED_MODULE_2_d3_shape__["a" /* arc */])()).attr('opacity', conf.opacity).attr('stroke-width', conf.strokeWidth).attr('stroke', conf.strokeColor).attr('fill', conf.colorValue);
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_clipboard_js__ = __webpack_require__(627);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_clipboard_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_clipboard_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_selection__ = __webpack_require__(3);


const initClipboard = container => {
  const input = Object(__WEBPACK_IMPORTED_MODULE_1_d3_selection__["d" /* select */])(container).append('input').attr('class', 'circos-clipboard').attr('type', 'hidden');
  Object(__WEBPACK_IMPORTED_MODULE_1_d3_selection__["d" /* select */])('body').on('keydown', () => {
    if (event.ctrlKey && event.code === 'KeyC') {
      __WEBPACK_IMPORTED_MODULE_0_clipboard_js___default.a.copy(input.attr('value'));
    }
  });
  return input;
};
/* harmony export (immutable) */ __webpack_exports__["a"] = initClipboard;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(628).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(79), __webpack_require__(630)))
